...
HD_PWD='/home/bimbom/Desktop/VivadoWorkspace/reg_file/reg_file.runs/impl_5'
cd "$HD_PWD"
...
EAStep vivado -log interpolator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interpolator.tcl -notrace
