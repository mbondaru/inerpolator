...
HD_PWD='/home/bimbom/Desktop/VivadoWorkspace/reg_file/reg_file.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interpolator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interpolator.tcl
